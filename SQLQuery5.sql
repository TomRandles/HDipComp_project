...
/* delete from Programmes where ProgrammeID='BS0501' */
...
VALUES ('M10501', 'Maths', 'Maths', 5, '04/07/2019'),
       ...
       ('SA0601', 'Software Architecture', 'Software Architecture', 5, '04/07/2019'),
	...
	('BA0501', 'Fundamentals of Biomechanics', 'Fundamentals of Biomechanics', 5, '04/07/2019'),
	('A00501', 'Fundamentals of Anatomy', 'Fundamentals of Anatomy', 5, '04/07/2019'),
...
VALUES ('MEX501', 'Maths exam 1', 'Maths exam 1', 'Exam', 60, 'M10501', '04/07/2019');

INSERT INTO Assessments (AssessmentID, AssessmentNAME, AssessmentDescription, AssessmentType, AssessmentTotalMark, ModuleID, LastUpdated)
VALUES ('MEX501', 'Maths exam 1', 'Maths exam 1', 1, 60, 'M10501', '04/07/2019');
select * from Assessments
delete from Assessments where AssessmentID='L6MthP'
select * from Modules
INSERT INTO Assessments (AssessmentID, AssessmentNAME, AssessmentDescription, AssessmentType, AssessmentTotalMark, ModuleID, LastUpdated)
VALUES 
